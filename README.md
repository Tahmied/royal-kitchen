...
```bash
PORT = 8000
MONGODB_URI = mongodb+srv://tahmied:tahmiedhossain@royal-kitchen-cluster.agmdk9r.mongodb.net

# auth
ADMIN_ACCESS_TOKEN_KEY = mJDhcWqSfj9lAb4muZtGeJZz46vsiGOdA3HBLzwl0yG94PRiXsmhf6XISFkkSRg0
ADMIN_ACCESS_TOKEN_EXPIRY = 1d

ADMIN_REFRESH_TOKEN_KEY = 5ehfxFBOWcS1POY7PgXTY6LyzBjeAOEHJGAga6edvHquCFbXkEeK2rGuitJWg6PL
ADMIN_REFRESH_TOKEN_EXPIRY = 10d

SALES_ACCESS_TOKEN_KEY = AgK4K9IbvqFylT5dB6S2Gp4Fx7uig591ory65PC1mAkpWjBR0FP3oHqSJDGb6GyZ
SALES_ACCESS_TOKEN_EXPIRY = 1d

SALES_REFRESH_TOKEN_KEY = 5tASlbWev5A3Oz726avfGQaeoVXKWGqtDhYd5lJCoEEbQhUovxaP4EibjA7xXH7L
SALES_REFRESH_TOKEN_EXPIRY = 10d
```
